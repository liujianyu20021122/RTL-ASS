...
3. Run the starter design through Icarus simulation, Verilator lint, Yosys synthesis/formal, waveform/FST, and OpenSTA; run an independent self-checking fixture through Verilator binary simulation. Native SBY/EQY tests use matching source-pinned Yosys, SBY, EQY, and a hash-pinned SMT solver.
